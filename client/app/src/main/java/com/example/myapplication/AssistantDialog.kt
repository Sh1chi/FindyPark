...
class AssistantDialog : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        addMessage("Привет! Я помогу вам с вопросами об интерфейсе приложения: Личный кабинет, Карта, Настройки темы, Меню.", false)
    ...
    private fun sendQuestionToServer(question: String) {
        ...
        val request = Request.Builder()
            .url("http://192.168.1.51:8000/assistant/ask")
            .post(body)
            .build()
